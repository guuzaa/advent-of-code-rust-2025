...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `47.3µs` | `46.9µs` |
| [Day 2](./src/bin/02.rs) | `45.1ms` | `263.0ms` |
| [Day 3](./src/bin/03.rs) | `14.9µs` | `79.1µs` |
| [Day 4](./src/bin/04.rs) | `64.7µs` | `12.2ms` |
| [Day 5](./src/bin/05.rs) | `48.4µs` | `14.9µs` |
| [Day 6](./src/bin/06.rs) | `26.3µs` | `21.6µs` |
| [Day 7](./src/bin/07.rs) | `16.8µs` | `15.1µs` |
| [Day 8](./src/bin/08.rs) | `12.7ms` | `12.9ms` |
| [Day 9](./src/bin/09.rs) | `81.7µs` | `93.0ms` |
| [Day 10](./src/bin/10.rs) | `640.8µs` | `-` |
| [Day 11](./src/bin/11.rs) | `183.7µs` | `428.2µs` |
